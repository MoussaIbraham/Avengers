...
public class VentanaClienteSMTP extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaClienteSMTP frame = new VentanaClienteSMTP(username, pasword, mimodelo);
	 ...
	 * @param mimodelo 
	 */
	public VentanaClienteSMTP(String user, String password, Modelo mimodelo) {
		...
		assunt.setBackground(new Color(227, 27, 35));
		...
		buttonSend.setBounds(408, 290, 97, 29);
		...
		btnNewButton.setBounds(225, 287, 97, 32);
		assunt.add(btnNewButton);

		JButton cancel = new JButton(modelo.getTextoSMTPBotonCancelar());
		cancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				POP3 pop = new POP3(mimodelo, user, password);
				pop.setVisible(true);
				dispose();
			}
		});
		cancel.setBounds(81, 287, 97, 32);
		assunt.add(cancel);
