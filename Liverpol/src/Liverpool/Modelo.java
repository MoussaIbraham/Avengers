...
public class Modelo {
	...
	// Ventana Login
	private String TextoVentanaLogin = "Login", TextoLabelUsusario = "User: ", TextoLabelContraseña = "Password: ",
			TextoBotonLoguearse = "Enter", TextoBotonCancelar = "Cancel", TextoVentanaemergenteLoginExito = "Connected",
			TextoVentanaemergenteLoginError = "Error, please Introduce a correct user or password.",
			AlmacenNombreUsuario = "", AlmacenContraseña = "",
			...
			// Ventana menú
			TextoVentanaMenu = "Menu", TextoBotonGestion = "Open Management", TextoBotonCorreo = "Open Mail",
			TextoBotonSalir = "Exit",

			// Ventana principal
			TextoVentanaPrincipal = "Management", TextoLabelbotonesGestion = "File management",

			// Crear carpeta gestion
			TextoBotonCrear = "Create Folder", TextoGestionAyudaCrear = "Set the name of the folder you want to create",
			TextoGestionAyudaCrear2 = "Folder",
			TextoVentanaEmergenteGestionCrearCarpetaExito = " was correctly created",

			TextoBotonRenombrar = "Rename", TextoBotonBorrar = "Delete Folder", TextoBotonBorrar2 = "Delete File",
			TextoBotonCerrar = "Close",

			// Subidas y bajadas
			TextoLabelBotonesSubidaBajada = "Uploads and Downloads", TextoBotonsubida = "Upload File",
			TextoBotonBajada = "Download File",
			// Gestion subida
			...
			TextoGestionAyudaSubida2 = "Select the file you want to upload.", TextoGestionAyudaSubida3 = "Select.",
			// Gestion bajada
			...
			TextoVentanaCrearCarpeta = "Create folder", TextoLabelNombrecarpeta = "Folder name: ",
			TextoBotonCrearCarpeta = "Create",
			// Boton cancel reutilizable aqui

			// Ventana Modificar nombre
			TextoVentanaRenombrar = "Rename File", TextoLabelNuevoNombre = "New name: ", TextoBotonRenombre = "Rename",
			// Boton cancel reutilizable aqui
			...
			// Ventana Logincorreo
			LoginCorreoTextoLabeluser = "Email: ", LoginCorreoTextoLabelpassword = "Password: ",
			LoginCorreoTextoBotonLogin = "Login", LoginCorreoTextoBotonCancel = "Cancel", LoginCorreoCajaCorreo = "",
			LoginCorreoCajacontraseña = "",

			// Ventana LeerCorreo
			VerCorreoTextoLabelde = "From:", VerCorreoTextoLabelAsunto = "Subject:",

			// Ventana correo pop
			TextoPOPBotonAbrirCorreo = "Open Mail", TextoPOPBotonEscribirCorreo = "Send Mail",
			TextoPOPBotonCerrarCorreo = "Close Mail", TextoPOPBotonActualizarCorreo = "Refresh",
			...
			TextoSMTPLabelAsunto = "Subject", TextoSMTPLabelCuerpo = "Text",
			TextoSMTPButtonAñadirArchivo = "Attach files", TextoSMTPBotonEnviar = "Send Mail",
